...
describe BusinessStatsCalculator do
  ...
  it 'finds the most sold item' do
    expect(business_stats_calculator.find_most_sold_item(purchases_data))
      .to eq 'Some purchaseable item'
  end

  it 'finds the most loyal customer' do
    expect(business_stats_calculator.find_most_loyal_user_id(purchases_data))
      .to eq '12DF-2324-GA2D-31RT'
  end

  it 'finds the highest value customer' do
    expect(business_stats_calculator
